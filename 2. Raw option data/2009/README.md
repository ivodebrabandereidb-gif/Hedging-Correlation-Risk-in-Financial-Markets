...
It is important that the zero coupon bond returns file bears the name "zerocd_<YYYY>.csv" and contains returns on a zero coupon bond over different maturities for the year 2009.
The csv should be comma separated and uses "." as decimal separator.
